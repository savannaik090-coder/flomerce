...
// .wrangler/tmp/bundle-7ZN5T5/checked-fetch.js
...
// .wrangler/tmp/bundle-7ZN5T5/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-7ZN5T5/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-7ZN5T5/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
__name(getDefaultProductPolicies, "getDefaultProductPolicies");
...
async function activateSubscription(env, userId, planName, billingCycle, razorpayPaymentId, razorpaySubscriptionId, amount) {
  try {
    await env.DB.prepare(`
      CREATE TABLE IF NOT EXISTS subscriptions (
        id TEXT PRIMARY KEY,
