...
// .wrangler/tmp/bundle-0NrxPw/checked-fetch.js
...
// .wrangler/tmp/bundle-0NrxPw/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-0NrxPw/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-0NrxPw/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
async function getOrders(request, env, user) {
  try {
    ...
    const bindings = [];
    const authHeader = request.headers.get("Authorization");
    const isSiteAdmin = authHeader && authHeader.startsWith("SiteAdmin ");
