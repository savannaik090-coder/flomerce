...
// .wrangler/tmp/bundle-w3NI9G/checked-fetch.js
...
// .wrangler/tmp/bundle-w3NI9G/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-w3NI9G/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-w3NI9G/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
async function updatePlan(request, env, planId) {
  try {
    ...
    await env.DB.prepare(
      ...
      plan_tier ?? existing.plan_tier ?? 1,
      planId
    ).run();
