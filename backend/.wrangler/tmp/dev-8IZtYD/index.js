...
// .wrangler/tmp/bundle-v80BOk/checked-fetch.js
...
// .wrangler/tmp/bundle-v80BOk/strip-cf-connecting-ip-header.js
...
async function createSite(request, env, user) {
  ...
  try {
    ...
    siteId = generateId();
    await env.DB.prepare(
      `INSERT INTO sites (id, user_id, subdomain, brand_name, category, template_id, logo_url, phone, email, address, primary_color, secondary_color, is_active, subscription_plan, created_at)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1, 'free', datetime('now'))`
    ).bind(
      siteId,
      user.id,
      finalSubdomain,
...
// .wrangler/tmp/bundle-v80BOk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-v80BOk/middleware-loader.entry.ts
