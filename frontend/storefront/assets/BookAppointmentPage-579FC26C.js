import{d as k,u as w,r as i,i as T,j as e,N as C,T as o,A}from"./index-BMEfnzv_.js";import{P as D}from"./PhoneInput-I7PShBqX.js";const z=["11:00 AM","12:00 PM","01:00 PM","02:00 PM","03:00 PM","04:00 PM","05:00 PM","06:00 PM"];function I(){const{translate:p}=k(),f=[{value:"",label:p("Select purpose")},{value:"consultation",label:p("General Consultation")},{value:"other",label:p("Other")}],{siteConfig:n}=w(),[l,d]=i.useState(""),[m,g]=i.useState(""),[c,a]=i.useState(null),[h,b]=i.useState(!1),[s,x]=i.useState({fullName:"",email:"",phone:"",appointmentDate:"",purpose:"",notes:""}),v=T(n?.subscriptionPlan,"growth");if(n&&!v)return e.jsx(C,{to:"/",replace:!0});function r(t){x({...s,[t.target.name]:t.target.value})}function N(){const t=new Date;return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}async function P(t){if(t.preventDefault(),!l){a({type:"error",msg:"Please select an appointment type."});return}if(!m){a({type:"error",msg:"Please select a time slot."});return}b(!0),a(null);try{const u=f.find(S=>S.value===s.purpose)?.label||s.purpose,j=await fetch(`${A}/api/email/appointment`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:s.fullName,email:s.email,phone:s.phone,date:s.appointmentDate,time:m,notes:`Type: ${l}
Purpose: ${u}${s.notes?`
`+s.notes:""}`,siteEmail:n?.email,brandName:n?.brandName,siteId:n?.id})}),y=await j.json();j.ok&&y.success?(a({type:"success",msg:"Your appointment has been booked successfully! We'll send you a confirmation shortly."}),x({fullName:"",email:"",phone:"",appointmentDate:"",purpose:"",notes:""}),d(""),g("")):a({type:"error",msg:y.error||"Something went wrong. Please try again."})}catch{a({type:"error",msg:"Something went wrong. Please try again."})}finally{b(!1)}}return e.jsxs("div",{className:"book-appointment-page",children:[e.jsx("style",{children:`
