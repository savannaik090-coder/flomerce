import{u as g,b,j as e,r as h,A as j}from"./index-fNFR3EF2.js";import{u as y}from"./useSEO-DJi18sTM.js";import{P as u}from"./PhoneInput-TCPup27a.js";function N(t){const[n,s]=h.useState({name:"",email:"",phone:"",subject:"",message:""}),[l,i]=h.useState(null),[a,r]=h.useState(!1);function m(c){s({...n,[c.target.name]:c.target.value})}async function d(c){c.preventDefault(),r(!0),i(null);try{const o=await fetch(`${j}/api/email/contact`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:n.name,email:n.email,phone:n.phone,message:`${n.subject?`Subject: ${n.subject}

`:""}${n.message}`,siteEmail:t?.email,brandName:t?.brandName})}),f=await o.json();o.ok&&f.success?(i("success"),s({name:"",email:"",phone:"",subject:"",message:""})):i("error")}catch{i("error")}finally{r(!1)}}return{form:n,setForm:s,status:l,submitting:a,handleChange:m,handleSubmit:d}}function v({siteConfig:t,brandName:n,phone:s,email:l,address:i,socialLinks:a,form:r,setForm:m,status:d,submitting:c,handleChange:o,handleSubmit:f}){return e.jsxs("div",{className:"contact-page",children:[e.jsx("style",{children:`
        .contact-hero {
      ...
      `}),e.jsx("section",{className:"contact-hero",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"contact-hero-content",children:[e.jsx("h1",{children:"Contact Us"}),e.jsx("p",{children:"Reach out to us for any inquiries. We'd love to hear from you."})]})})}),e.jsx("section",{className:"contact-section",children:e.jsxs("div",{className:"contact-container",children:[e.jsxs("div",{className:"contact-info",children:[e.jsx("h2",{children:"Get in Touch"}),e.jsx("p",{children:"Have questions about our collections? We're here to help you discover what you're looking for."}),e.jsxs("ul",{className:"contact-details",children:[i&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-map-marker-alt"}),e.jsx("span",{children:i})]}),s&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-phone"}),e.jsx("a",{href:`tel:${s}`,children:s})]}),l&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-envelope"}),e.jsx("a",{href:`mailto:${l}`,children:l})]}),s&&e.jsxs("li",{children:[e.jsx("i",{className:"fab fa-whatsapp"}),e.jsx("a",{href:`https://wa.me/${s.replace(/[^0-9]/g,"")}`,target:"_blank",rel:"noopener noreferrer",children:s})]})]}),(a.instagram||a.facebook||a.twitter||a.youtube)&&e.jsxs("div",{className:"social-links-section",children:[e.jsx("h3",{children:"Follow Us"}),e.jsxs("div",{className:"social-icons-row",children:[a.facebook&&e.jsx("a",{href:a.facebook,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-facebook-f"})}),a.instagram&&e.jsx("a",{href:a.instagram,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-instagram"})}),a.twitter&&e.jsx("a",{href:a.twitter,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-twitter"})}),a.youtube&&e.jsx("a",{href:a.youtube,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-youtube"})})]})]})]}),e.jsxs("div",{className:"form-container",children:[e.jsx("h2",{children:"Send Us a Message"}),d==="success"&&e.jsxs("div",{className:"contact-status-msg success",children:[e.jsx("i",{className:"fas fa-check-circle"})," Your message has been sent successfully!"]}),d==="error"&&e.jsxs("div",{className:"contact-status-msg error",children:[e.jsx("i",{className:"fas fa-exclamation-circle"})," Something went wrong. Please try again."]}),e.jsxs("form",{onSubmit:f,children:[e.jsxs("div",{className:"form-row",children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Full Name *"}),e.jsx("input",{type:"text",name:"name",value:r.name,onChange:o,required:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Email Address *"}),e.jsx("input",{type:"email",name:"email",value:r.email,onChange:o,required:!0})]})]}),e.jsxs("div",{className:"form-row",children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Phone Number"}),e.jsx(u,{value:r.phone,onChange:x=>m(p=>({...p,phone:x})),countryCode:"IN"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Subject *"}),e.jsx("input",{type:"text",name:"subject",value:r.subject,onChange:o,required:!0})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Message *"}),e.jsx("textarea",{name:"message",value:r.message,onChange:o,required:!0,placeholder:"How can we help you?"})]}),e.jsx("button",{type:"submit",className:"contact-submit-btn",disabled:c,children:c?"Sending...":"Send Message"})]})]})]})}),e.jsxs("section",{className:"working-hours",children:[e.jsx("h2",{children:"Working Hours"}),e.jsxs("div",{className:"hours-grid",children:[e.jsxs("div",{className:"hours-item",children:[e.jsx("h3",{children:"Monday - Saturday"}),e.jsx("p",{children:"10:00 AM - 7:00 PM"})]}),e.jsxs("div",{className:"hours-item",children:[e.jsx("h3",{children:"Sunday"}),e.jsx("p",{children:"11:00 AM - 6:00 PM"})]})]})]})]})}function w({siteConfig:t,brandName:n,phone:s,email:l,address:i,socialLinks:a,form:r,setForm:m,status:d,submitting:c,handleChange:o,handleSubmit:f}){return e.jsxs("div",{children:[e.jsxs("section",{className:"mn-contact-hero",children:[e.jsx("h1",{children:"Contact Us"}),e.jsx("p",{children:"Reach out to us for any inquiries. We'd love to hear from you."})]}),e.jsx("section",{className:"mn-contact-section",children:e.jsxs("div",{className:"mn-contact-container",children:[e.jsxs("div",{className:"mn-contact-info",children:[e.jsx("h2",{children:"Get in Touch"}),e.jsx("p",{children:"Have questions about our collections? We're here to help you discover what you're looking for."}),e.jsxs("ul",{className:"mn-contact-details",children:[i&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-map-marker-alt"}),e.jsx("span",{children:i})]}),s&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-phone"}),e.jsx("a",{href:`tel:${s}`,children:s})]}),l&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-envelope"}),e.jsx("a",{href:`mailto:${l}`,children:l})]}),s&&e.jsxs("li",{children:[e.jsx("i",{className:"fab fa-whatsapp"}),e.jsx("a",{href:`https://wa.me/${s.replace(/[^0-9]/g,"")}`,target:"_blank",rel:"noopener noreferrer",children:s})]})]}),(a.instagram||a.facebook||a.twitter||a.youtube)&&e.jsxs("div",{className:"mn-contact-social",children:[e.jsx("h3",{children:"Follow Us"}),e.jsxs("div",{className:"mn-contact-social-icons",children:[a.facebook&&e.jsx("a",{href:a.facebook,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-facebook-f"})}),a.instagram&&e.jsx("a",{href:a.instagram,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-instagram"})}),a.twitter&&e.jsx("a",{href:a.twitter,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-twitter"})}),a.youtube&&e.jsx("a",{href:a.youtube,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-youtube"})})]})]})]}),e.jsxs("div",{className:"mn-contact-form",children:[e.jsx("h2",{children:"Send Us a Message"}),d==="success"&&e.jsxs("div",{className:"mn-contact-status success",children:[e.jsx("i",{className:"fas fa-check-circle"})," Your message has been sent successfully!"]}),d==="error"&&e.jsxs("div",{className:"mn-contact-status error",children:[e.jsx("i",{className:"fas fa-exclamation-circle"})," Something went wrong. Please try again."]}),e.jsxs("form",{onSubmit:f,children:[e.jsxs("div",{className:"mn-form-row",children:[e.jsxs("div",{className:"mn-form-group",children:[e.jsx("label",{children:"Full Name *"}),e.jsx("input",{type:"text",name:"name",value:r.name,onChange:o,required:!0})]}),e.jsxs("div",{className:"mn-form-group",children:[e.jsx("label",{children:"Email Address *"}),e.jsx("input",{type:"email",name:"email",value:r.email,onChange:o,required:!0})]})]}),e.jsxs("div",{className:"mn-form-row",children:[e.jsxs("div",{className:"mn-form-group",children:[e.jsx("label",{children:"Phone Number"}),e.jsx(u,{value:r.phone,onChange:x=>m(p=>({...p,phone:x})),countryCode:"IN"})]}),e.jsxs("div",{className:"mn-form-group",children:[e.jsx("label",{children:"Subject *"}),e.jsx("input",{type:"text",name:"subject",value:r.subject,onChange:o,required:!0})]})]}),e.jsxs("div",{className:"mn-form-group",children:[e.jsx("label",{children:"Message *"}),e.jsx("textarea",{name:"message",value:r.message,onChange:o,required:!0,placeholder:"How can we help you?"})]}),e.jsx("button",{type:"submit",className:"mn-contact-submit",disabled:c,children:c?"Sending...":"Send Message"})]})]})]})}),e.jsxs("section",{className:"mn-working-hours",children:[e.jsx("h2",{children:"Working Hours"}),e.jsxs("div",{className:"mn-hours-grid",children:[e.jsxs("div",{className:"mn-hours-item",children:[e.jsx("h3",{children:"Monday - Saturday"}),e.jsx("p",{children:"10:00 AM - 7:00 PM"})]}),e.jsxs("div",{className:"mn-hours-item",children:[e.jsx("h3",{children:"Sunday"}),e.jsx("p",{children:"11:00 AM - 6:00 PM"})]})]})]})]})}function C(){const{siteConfig:t}=g(),{isModern:n}=b();y({title:"Contact Us",pageType:"contact"});const s=t?.brandName||"Our Store",l=t?.phone||"",i=t?.email||"",a=t?.address||"",r=t?.socialLinks||{},{form:m,setForm:d,status:c,submitting:o,handleChange:f,handleSubmit:x}=N(t),p={siteConfig:t,brandName:s,phone:l,email:i,address:a,socialLinks:r,form:m,setForm:d,status:c,submitting:o,handleChange:f,handleSubmit:x};return n?e.jsx(w,{...p}):e.jsx(v,{...p})}export{C as default};
