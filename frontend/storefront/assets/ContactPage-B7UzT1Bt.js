import{u as b,r as l,j as e}from"./index-vqew1Iz9.js";function y(){const{siteConfig:s}=b();s?.brandName;const t=s?.phone||"",i=s?.email||"",d=s?.address||"",a=s?.socialLinks||{},[o,p]=l.useState({name:"",email:"",phone:"",subject:"",message:""}),[f,c]=l.useState(null),[m,x]=l.useState(!1);function r(n){p({...o,[n.target.name]:n.target.value})}async function g(n){n.preventDefault(),x(!0),c(null);try{const h=t.replace(/[^0-9]/g,""),u=`Name: ${o.name}%0AEmail: ${o.email}%0APhone: ${o.phone}%0ASubject: ${o.subject}%0AMessage: ${o.message}`;window.open(`https://wa.me/${h}?text=${u}`,"_blank"),c("success"),p({name:"",email:"",phone:"",subject:"",message:""})}catch{c("error")}finally{x(!1)}}return e.jsxs("div",{className:"contact-page",children:[e.jsx("style",{children:`
        .contact-hero {
      ...
      `}),e.jsx("section",{className:"contact-hero",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"contact-hero-content",children:[e.jsx("h1",{children:"Contact Us"}),e.jsx("p",{children:"Reach out to us for any inquiries. We'd love to hear from you."})]})})}),e.jsx("section",{className:"contact-section",children:e.jsxs("div",{className:"contact-container",children:[e.jsxs("div",{className:"contact-info",children:[e.jsx("h2",{children:"Get in Touch"}),e.jsx("p",{children:"Have questions about our collections? We're here to help you discover what you're looking for."}),e.jsxs("ul",{className:"contact-details",children:[d&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-map-marker-alt"}),e.jsx("span",{children:d})]}),t&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-phone"}),e.jsx("a",{href:`tel:${t}`,children:t})]}),i&&e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-envelope"}),e.jsx("a",{href:`mailto:${i}`,children:i})]}),t&&e.jsxs("li",{children:[e.jsx("i",{className:"fab fa-whatsapp"}),e.jsx("a",{href:`https://wa.me/${t.replace(/[^0-9]/g,"")}`,target:"_blank",rel:"noopener noreferrer",children:t})]})]}),(a.instagram||a.facebook||a.twitter||a.youtube)&&e.jsxs("div",{className:"social-links-section",children:[e.jsx("h3",{children:"Follow Us"}),e.jsxs("div",{className:"social-icons-row",children:[a.facebook&&e.jsx("a",{href:a.facebook,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-facebook-f"})}),a.instagram&&e.jsx("a",{href:a.instagram,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-instagram"})}),a.twitter&&e.jsx("a",{href:a.twitter,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-twitter"})}),a.youtube&&e.jsx("a",{href:a.youtube,target:"_blank",rel:"noopener noreferrer",children:e.jsx("i",{className:"fab fa-youtube"})})]})]})]}),e.jsxs("div",{className:"form-container",children:[e.jsx("h2",{children:"Send Us a Message"}),f==="success"&&e.jsxs("div",{className:"contact-status-msg success",children:[e.jsx("i",{className:"fas fa-check-circle"})," Your message has been sent successfully!"]}),f==="error"&&e.jsxs("div",{className:"contact-status-msg error",children:[e.jsx("i",{className:"fas fa-exclamation-circle"})," Something went wrong. Please try again."]}),e.jsxs("form",{onSubmit:g,children:[e.jsxs("div",{className:"form-row",children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Full Name *"}),e.jsx("input",{type:"text",name:"name",value:o.name,onChange:r,required:!0})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Email Address *"}),e.jsx("input",{type:"email",name:"email",value:o.email,onChange:r,required:!0})]})]}),e.jsxs("div",{className:"form-row",children:[e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Phone Number"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,onChange:r})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Subject *"}),e.jsx("input",{type:"text",name:"subject",value:o.subject,onChange:r,required:!0})]})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{children:"Message *"}),e.jsx("textarea",{name:"message",value:o.message,onChange:r,required:!0,placeholder:"How can we help you?"})]}),e.jsx("button",{type:"submit",className:"contact-submit-btn",disabled:m,children:m?"Sending...":"Send Message"})]})]})]})}),e.jsxs("section",{className:"working-hours",children:[e.jsx("h2",{children:"Working Hours"}),e.jsxs("div",{className:"hours-grid",children:[e.jsxs("div",{className:"hours-item",children:[e.jsx("h3",{children:"Monday - Saturday"}),e.jsx("p",{children:"10:00 AM - 7:00 PM"})]}),e.jsxs("div",{className:"hours-item",children:[e.jsx("h3",{children:"Sunday"}),e.jsx("p",{children:"11:00 AM - 6:00 PM"})]})]})]})]})}export{y as default};
