import{u as b,r as l,j as e,A as j}from"./index-CK3fVl_H.js";import{u as y}from"./useSEO-B8D-9P2w.js";function N(){const{siteConfig:t}=b();y({title:"Contact Us",pageType:"contact"}),t?.brandName;const s=t?.phone||"",c=t?.email||"",d=t?.address||"",a=t?.socialLinks||{},[o,p]=l.useState({name:"",email:"",phone:"",subject:"",message:""}),[f,n]=l.useState(null),[m,x]=l.useState(!1);function r(i){p({...o,[i.target.name]:i.target.value})}async function h(i){i.preventDefault(),x(!0),n(null);try{const g=await fetch(`${j}/api/email/contact`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o.name,email:o.email,phone:o.phone,message:`${o.subject?`Subject: ${o.subject}

`:""}${o.message}`,siteEmail:t?.email,brandName:t?.brandName})}),u=await g.json();g.ok&&u.success?(n("success"),p({name:"",email:"",phone:"",subject:"",message:""})):n("error")}catch{n("error")}finally{x(!1)}}return e.jsxs("div",{className:"contact-page",children:[e.jsx("style",{children:`
        .contact-hero {
