import{b,u as j,c as y,j as e,r as h,A as N}from"./index-C2D4NmPf.js";import{u as v}from"./useSEO-uLZ2nFNI.js";import{P as g}from"./PhoneInput-CX8XtWde.js";function w(m){const[t,o]=h.useState({name:"",email:"",phone:"",subject:"",message:""}),[l,c]=h.useState(null),[s,n]=h.useState(!1);function f(i){o({...t,[i.target.name]:i.target.value})}async function d(i){i.preventDefault(),n(!0),c(null);try{const r=await fetch(`${N}/api/email/contact`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t.name,email:t.email,phone:t.phone,message:`${t.subject?`Subject: ${t.subject}
