import{r as d,S as m,j as o}from"./index-BCR0Xtgb.js";function y(){const{siteConfig:e}=d.useContext(m),i=e?.brandName||e?.brand_name||"Our Store",r=e?.email||"support@example.com",s=`Welcome to ${i}. We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, and share information about you when you use our services.`,c=[{title:"1. Information We Collect",content:`We collect information you provide directly to us, such as when you create an account, make a purchase, or contact us for support. This includes:
