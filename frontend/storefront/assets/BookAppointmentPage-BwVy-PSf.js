import{u as S,r as n,j as e}from"./index-ieeXfnLl.js";const w=["11:00 AM","12:00 PM","01:00 PM","02:00 PM","03:00 PM","04:00 PM","05:00 PM","06:00 PM"],h=[{value:"",label:"Select purpose"},{value:"browse",label:"Browse Collection"},{value:"custom",label:"Custom Design"},{value:"repair",label:"Repair & Restoration"},{value:"consultation",label:"General Consultation"},{value:"wedding",label:"Wedding / Bridal"},{value:"gift",label:"Gift Selection"},{value:"other",label:"Other"}];function P(){const{siteConfig:c}=S(),[r,l]=n.useState(""),[p,d]=n.useState(""),[i,a]=n.useState(null),[m,u]=n.useState(!1),[o,x]=n.useState({fullName:"",email:"",phone:"",appointmentDate:"",purpose:"",notes:""});function s(t){x({...o,[t.target.name]:t.target.value})}function b(){const t=new Date;return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}const y=typeof window<"u"&&window.location.hostname.endsWith("fluxe.in")?"":"https://fluxe.in";async function j(t){if(t.preventDefault(),!r){a({type:"error",msg:"Please select an appointment type."});return}if(!p){a({type:"error",msg:"Please select a time slot."});return}u(!0),a(null);try{const v=h.find(N=>N.value===o.purpose)?.label||o.purpose,f=await fetch(`${y}/api/email/appointment`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o.fullName,email:o.email,phone:o.phone,date:o.appointmentDate,time:p,notes:`Type: ${r}
Purpose: ${v}${o.notes?`
`+o.notes:""}`,siteEmail:c?.email,brandName:c?.brandName})}),g=await f.json();f.ok&&g.success?(a({type:"success",msg:"Your appointment has been booked successfully! We'll send you a confirmation shortly."}),x({fullName:"",email:"",phone:"",appointmentDate:"",purpose:"",notes:""}),l(""),d("")):a({type:"error",msg:g.error||"Something went wrong. Please try again."})}catch{a({type:"error",msg:"Something went wrong. Please try again."})}finally{u(!1)}}return e.jsxs("div",{className:"book-appointment-page",children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"appointment-container",children:[e.jsxs("div",{className:"appointment-header",children:[e.jsx("h1",{children:"Book Your Appointment"}),e.jsx("p",{children:"Schedule a personalized consultation with our experts"})]}),i&&e.jsxs("div",{className:`appt-status-msg ${i.type}`,children:[e.jsx("i",{className:`fas fa-${i.type==="success"?"check":"exclamation"}-circle`})," ",i.msg]}),e.jsxs("form",{className:"appointment-form",onSubmit:j,children:[e.jsxs("div",{className:"form-section",children:[e.jsx("h3",{children:"Appointment Type"}),e.jsxs("div",{className:"appointment-type",children:[e.jsxs("div",{className:`type-option ${r==="in-store"?"selected":""}`,onClick:()=>l("in-store"),children:[e.jsx("i",{className:"fas fa-store"}),e.jsx("strong",{children:"In-Store Visit"}),e.jsx("div",{className:"type-desc",children:"Visit our showroom"})]}),e.jsxs("div",{className:`type-option ${r==="virtual"?"selected":""}`,onClick:()=>l("virtual"),children:[e.jsx("i",{className:"fas fa-video"}),e.jsx("strong",{children:"Virtual Consultation"}),e.jsx("div",{className:"type-desc",children:"Video call consultation"})]})]})]}),e.jsxs("div",{className:"form-section",children:[e.jsx("h3",{children:"Personal Information"}),e.jsxs("div",{className:"appt-form-group",children:[e.jsx("label",{children:"Full Name *"}),e.jsx("input",{type:"text",name:"fullName",value:o.fullName,onChange:s,required:!0})]}),e.jsxs("div",{className:"appt-form-group",children:[e.jsx("label",{children:"Email Address *"}),e.jsx("input",{type:"email",name:"email",value:o.email,onChange:s,required:!0})]}),e.jsxs("div",{className:"appt-form-group",children:[e.jsx("label",{children:"Phone Number *"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,onChange:s,required:!0})]})]}),e.jsxs("div",{className:"form-section",children:[e.jsx("h3",{children:"Select Date & Time"}),e.jsxs("div",{className:"appt-form-group",children:[e.jsx("label",{children:"Preferred Date *"}),e.jsx("input",{type:"date",name:"appointmentDate",value:o.appointmentDate,onChange:s,min:b(),required:!0})]}),e.jsxs("div",{className:"appt-form-group",children:[e.jsx("label",{children:"Preferred Time Slot *"}),e.jsx("div",{className:"time-slots",children:w.map(t=>e.jsx("div",{className:`time-slot ${p===t?"selected":""}`,onClick:()=>d(t),children:t},t))})]})]}),e.jsxs("div",{className:"form-section",children:[e.jsx("h3",{children:"Additional Details"}),e.jsxs("div",{className:"appt-form-group",children:[e.jsx("label",{children:"Purpose of Visit"}),e.jsx("select",{name:"purpose",value:o.purpose,onChange:s,children:h.map(t=>e.jsx("option",{value:t.value,children:t.label},t.value))})]}),e.jsxs("div",{className:"appt-form-group",children:[e.jsx("label",{children:"Additional Notes"}),e.jsx("textarea",{name:"notes",value:o.notes,onChange:s,placeholder:"Any specific requirements or questions..."})]})]}),e.jsx("button",{type:"submit",className:"appt-submit-btn",disabled:m,children:m?"Booking...":"Book Appointment"})]})]})]})}export{P as default};
