import{r as a,S as s,j as e}from"./index-BQDZDOr8.js";function l(){const{siteConfig:o}=a.useContext(s),n=o?.brand_name||"Our Store",i=o?.email||"support@example.com";return e.jsxs("div",{style:{maxWidth:800,margin:"120px auto 80px",padding:"0 20px",fontFamily:"inherit"},children:[e.jsx("h1",{style:{fontSize:32,fontWeight:700,marginBottom:8},children:"Privacy Policy"}),e.jsxs("p",{style:{color:"#64748b",marginBottom:40},children:["Last updated: ",new Date().toLocaleDateString("en-IN",{year:"numeric",month:"long",day:"numeric"})]}),e.jsxs("div",{style:{lineHeight:1.8,color:"#374151"},children:[e.jsxs("p",{style:{marginBottom:24},children:["Welcome to ",n,". We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, and share information about you when you use our services."]}),[{title:"1. Information We Collect",content:`We collect information you provide directly to us, such as when you create an account, make a purchase, or contact us for support. This includes:
