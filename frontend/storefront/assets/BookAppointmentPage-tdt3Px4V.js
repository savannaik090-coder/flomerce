import{u as N,r as n,j as e,A as P}from"./index-BGVZMyEK.js";import{P as S}from"./PhoneInput-AmzvzY8W.js";const k=["11:00 AM","12:00 PM","01:00 PM","02:00 PM","03:00 PM","04:00 PM","05:00 PM","06:00 PM"],b=[{value:"",label:"Select purpose"},{value:"consultation",label:"General Consultation"},{value:"other",label:"Other"}];function D(){const{siteConfig:d}=N(),[r,p]=n.useState(""),[l,u]=n.useState(""),[i,a]=n.useState(null),[x,f]=n.useState(!1),[o,c]=n.useState({fullName:"",email:"",phone:"",appointmentDate:"",purpose:"",notes:""});function s(t){c({...o,[t.target.name]:t.target.value})}function y(){const t=new Date;return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}async function j(t){if(t.preventDefault(),!r){a({type:"error",msg:"Please select an appointment type."});return}if(!l){a({type:"error",msg:"Please select a time slot."});return}f(!0),a(null);try{const m=b.find(v=>v.value===o.purpose)?.label||o.purpose,g=await fetch(`${P}/api/email/appointment`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o.fullName,email:o.email,phone:o.phone,date:o.appointmentDate,time:l,notes:`Type: ${r}
Purpose: ${m}${o.notes?`
`+o.notes:""}`,siteEmail:d?.email,brandName:d?.brandName})}),h=await g.json();g.ok&&h.success?(a({type:"success",msg:"Your appointment has been booked successfully! We'll send you a confirmation shortly."}),c({fullName:"",email:"",phone:"",appointmentDate:"",purpose:"",notes:""}),p(""),u("")):a({type:"error",msg:h.error||"Something went wrong. Please try again."})}catch{a({type:"error",msg:"Something went wrong. Please try again."})}finally{f(!1)}}return e.jsxs("div",{className:"book-appointment-page",children:[e.jsx("style",{children:`
