import{u as j,r as l,j as e}from"./index-D0uPbQM_.js";import{u as y}from"./useSEO-BV3JEkn9.js";function N(){const{siteConfig:t}=j();y({title:"Contact Us",pageType:"contact"}),t?.brandName;const s=t?.phone||"",c=t?.email||"",d=t?.address||"",a=t?.socialLinks||{},[o,p]=l.useState({name:"",email:"",phone:"",subject:"",message:""}),[f,r]=l.useState(null),[m,x]=l.useState(!1);function n(i){p({...o,[i.target.name]:i.target.value})}const h=typeof window<"u"&&window.location.hostname.endsWith("fluxe.in")?"":"https://fluxe.in";async function u(i){i.preventDefault(),x(!0),r(null);try{const g=await fetch(`${h}/api/email/contact`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o.name,email:o.email,phone:o.phone,message:`${o.subject?`Subject: ${o.subject}

`:""}${o.message}`,siteEmail:t?.email,brandName:t?.brandName})}),b=await g.json();g.ok&&b.success?(r("success"),p({name:"",email:"",phone:"",subject:"",message:""})):r("error")}catch{r("error")}finally{x(!1)}}return e.jsxs("div",{className:"contact-page",children:[e.jsx("style",{children:`
        .contact-hero {
