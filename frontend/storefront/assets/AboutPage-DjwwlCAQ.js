...
Our commitment extends beyond selling products – we are dedicated to building lasting relationships with our customers and ensuring satisfaction for generations to come.`};function w(t,a){const o=v[t]||j,s=a;return{heroSubtitle:o.heroSubtitle,storyHeading:o.storyHeading,storyText:o.storyText.replace(/\{brandName\}/g,s),storyImage:"",missionHeading:o.missionHeading,missionText:o.missionText.replace(/\{brandName\}/g,s)}}function T(){const{siteConfig:t}=f(),a=t?.brandName||t?.name||"Our Store",o=t?.category||"";let s=t?.settings||{};if(typeof s=="string")try{s=JSON.parse(s)}catch{s={}}const n=s.aboutPage||{},r=w(o,a),m=n.heroSubtitle||r.heroSubtitle,h=n.storyHeading||r.storyHeading,y=n.storyText||r.storyText,l=n.storyImage||r.storyImage,d=n.missionHeading||r.missionHeading,g=n.missionText||r.missionText,b=y.split(`

`).filter(i=>i.trim()),p=g.split(`

`).filter(i=>i.trim()),u=l?x(l):"";return e.jsxs("div",{className:"about-page",children:[e.jsxs("section",{className:"about-hero",children:[e.jsx("div",{className:"about-hero-overlay"}),e.jsxs("div",{className:"about-hero-inner",children:[e.jsx("span",{className:"about-hero-label",children:"Our Story"}),e.jsxs("h1",{children:["About ",a]}),e.jsx("p",{children:m}),e.jsx("div",{className:"about-hero-divider"})]})]}),e.jsx("section",{className:"about-story",children:e.jsxs("div",{className:"about-story-inner",children:[e.jsxs("div",{className:"about-story-image-wrap",children:[u?e.jsx("img",{src:u,alt:a,className:"about-story-img"}):t?.logoUrl?e.jsx("img",{src:t.logoUrl,alt:a,className:"about-story-img"}):e.jsx("div",{className:"about-story-placeholder",children:e.jsx("i",{className:"fas fa-store"})}),e.jsx("div",{className:"about-story-image-accent"})]}),e.jsxs("div",{className:"about-story-text",children:[e.jsx("span",{className:"about-section-eyebrow",children:h}),e.jsx("h2",{children:a}),e.jsx("div",{className:"about-story-divider"}),b.map((i,c)=>e.jsx("p",{children:i},c))]})]})}),e.jsxs("section",{className:"about-mission",children:[e.jsx("div",{className:"about-mission-bg"}),e.jsxs("div",{className:"about-mission-inner",children:[e.jsx("span",{className:"about-mission-eyebrow",children:d}),e.jsx("h2",{children:d}),e.jsx("div",{className:"about-mission-divider"}),e.jsx("div",{className:"about-mission-text",children:p.map((i,c)=>e.jsx("p",{children:i},c))})]})]})]})}export{T as default};
