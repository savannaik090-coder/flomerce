...
export const trendingProductsDefaults = [
  { id: 'demo-j-1', name: 'Gold Necklace Set', slug: 'demo', price: 24999, compare_at_price: 29999, images: [], _isDemo: true },
  { id: 'demo-j-2', name: 'Diamond Earrings', slug: 'demo', price: 18999, compare_at_price: 22999, images: [], _isDemo: true },
  { id: 'demo-j-3', name: 'Bridal Choker', slug: 'demo', price: 34999, compare_at_price: 39999, images: [], _isDemo: true },
  { id: 'demo-j-4', name: 'Temple Bangles', slug: 'demo', price: 9999, compare_at_price: 12999, images: [], _isDemo: true },
  { id: 'demo-j-5', name: 'Solitaire Ring', slug: 'demo', price: 15999, compare_at_price: 19999, images: [], _isDemo: true },
  { id: 'demo-j-6', name: 'Pearl Pendant', slug: 'demo', price: 4999, compare_at_price: 6999, images: [], _isDemo: true },
  { id: 'demo-j-7', name: 'Kundan Set', slug: 'demo', price: 28999, compare_at_price: 34999, images: [], _isDemo: true },
  { id: 'demo-j-8', name: 'Gold Bracelet', slug: 'demo', price: 12999, compare_at_price: 15999, images: [], _isDemo: true },
];

export const demoCategoriesDefaults = [
  { id: 'demo-cat-j-1', name: 'Necklaces', slug: 'demo', subtitle: 'Statement neckpieces', image_url: '', browseImage: '', _isDemo: true },
  { id: 'demo-cat-j-2', name: 'Earrings', slug: 'demo', subtitle: 'Studs to chandeliers', image_url: '', browseImage: '', _isDemo: true },
  { id: 'demo-cat-j-3', name: 'Rings', slug: 'demo', subtitle: 'Timeless rings', image_url: '', browseImage: '', _isDemo: true },
  { id: 'demo-cat-j-4', name: 'Bridal', slug: 'demo', subtitle: 'For your big day', image_url: '', browseImage: '', _isDemo: true },
  { id: 'demo-cat-j-5', name: 'Bangles', slug: 'demo', subtitle: 'Tradition reimagined', image_url: '', browseImage: '', _isDemo: true },
  { id: 'demo-cat-j-6', name: 'Temple Jewellery', slug: 'demo', subtitle: 'Heritage craft', image_url: '', browseImage: '', _isDemo: true },
];
