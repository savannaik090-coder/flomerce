...
export const COUNTRY_STATES = {
  ...
  KE: ['Nairobi','Central','Coast','Eastern','North Eastern','Nyanza','Rift Valley','Western'],
  EG: [
  ...
  PH: [
    'Cebu','Davao del Sur','Iloilo','Laguna','Manila','Metro Manila','Pampanga',
    'Pangasinan','Quezon','Rizal','Zambales'
  ],
  VN: [
    'An Giang','Ba Ria-Vung Tau','Bac Giang','Bac Ninh','Ben Tre','Binh Duong',
    'Can Tho','Da Nang','Dong Nai','Ha Noi','Hai Phong','Ho Chi Minh City',
    'Khanh Hoa','Lam Dong','Long An','Quang Nam','Quang Ninh','Thanh Hoa','Thua Thien Hue'
  ],
  BD: [
  ...
  LK: [
    'Central','Eastern','North Central','North Western','Northern','Sabaragamuwa',
    'Southern','Uva','Western'
  ],
  NP: [
    'Province No. 1','Madhesh','Bagmati','Gandaki','Lumbini','Karnali','Sudurpashchim'
  ],
  IT: [
  ...
  ES: [
    ...
    'Cantabria','Castilla-La Mancha','Castilla y León','Catalonia','Ceuta','Extremadura',
  ...
  TR: ['Adana','Ankara','Antalya','Bursa','Diyarbakır','Eskişehir','Gaziantep','Istanbul','Izmir','Kayseri','Kocaeli','Konya','Malatya','Mersin','Muğla','Samsun','Trabzon'],
  IL: ['Central','Haifa','Jerusalem','North','South','Tel Aviv'],
  QA: [],
  KW: [],
  BH: [],
  ...
  RU: ['Moscow','Saint Petersburg','Krasnodar Krai','Sverdlovsk Oblast','Republic of Tatarstan','Novosibirsk Oblast','Chelyabinsk Oblast','Nizhny Novgorod Oblast','Samara Oblast','Rostov Oblast'],
  ...
  TZ: ['Arusha','Dar es Salaam','Dodoma','Geita','Iringa','Kagera','Kilimanjaro','Mwanza','Zanzibar'],
  UG: ['Central','Eastern','Northern','Western'],
  ET: ['Addis Ababa','Afar','Amhara','Benishangul-Gumuz','Dire Dawa','Gambela','Harari','Oromia','Sidama','Somali','SNNPR','Tigray'],
  MM: ['Ayeyarwady','Bago','Chin','Kachin','Kayah','Kayin','Magway','Mandalay','Mon','Naypyidaw','Rakhine','Sagaing','Shan','Tanintharyi','Yangon'],
  KH: ['Battambang','Kampong Cham','Kandal','Phnom Penh','Siem Reap','Sihanoukville'],
  HK: [],
  ...
  FI: ['Åland','Central Finland','Central Ostrobothnia','Kainuu','Kanta-Häme','Kymenlaakso','Lapland','North Karelia','North Ostrobothnia','North Savo','Ostrobothnia','Päijät-Häme','Pirkanmaa','Satakunta','South Karelia','South Ostrobothnia','South Savo','Southwest Finland','Uusimaa'],
  DK: ['Capital Region','Central Denmark','North Denmark','South Denmark','Zealand'],
  ...
  CZ: ['Central Bohemian','Hradec Králové','Karlovy Vary','Liberec','Moravia-Silesia','Olomouc','Pardubice','Plzeň','Prague','South Bohemian','South Moravian','Ústí nad Labem','Vysočina','Zlín'],
