    ...
    <div style={{ maxWidth: 800, margin: '40px auto 80px', padding: '0 20px', fontFamily: 'inherit' }}>
      ...
      <div style={{ lineHeight: 1.8, color: '#374151' }}>
        <p style={{ marginBottom: 24 }}>
          Please read these Terms and Conditions carefully before using {brand}'s website and services.
        ...
        {[
          ...
          },
          {
            ...
            content: `For any questions regarding these Terms and Conditions, please contact us at ${email}${siteConfig?.phone ? ` or ${siteConfig.phone}` : ''}.`,
          },
        ].map((section, i) => (
