    ...
    <div style={{ minHeight: '80vh' }}>
      <section style={{ maxWidth: 500, margin: '40px auto 60px', backgroundColor: '#fff', padding: 40, borderRadius: 10, boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
        <div style={{ textAlign: 'center', marginBottom: 30 }}>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, marginBottom: 10, color: '#333' }}><TranslatedText text="Reset Password" /></h2>
        ...
        {token && !success && (
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ display: 'block', marginBottom: 8, fontFamily: "'Lato', sans-serif", fontSize: 14, color: '#333', fontWeight: 600 }}><TranslatedText text="Confirm Password" /></label>
        ...
        <div style={{ textAlign: 'center', marginTop: 20, fontFamily: "'Lato', sans-serif", fontSize: 14, color: '#777' }}>
          <Link to="/login" style={{ color: '#c8a97e', textDecoration: 'none' }}><TranslatedText text="Back to Login" /></Link>
        </div>
      </section>
    </div>
  );
