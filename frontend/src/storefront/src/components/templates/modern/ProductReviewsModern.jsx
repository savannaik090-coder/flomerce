...
export default function ProductReviewsModern({ productId }) {
  ...
  return (
    <div className="mn-product-reviews">
      <h2 className="mn-product-reviews-title"><TranslatedText text="Customer Reviews" /></h2>
      ...
      {loading && reviews.length === 0 ? (
        ...
        <>
          ...
          {eligibility?.reason === 'already_reviewed' && (
            <div className="mn-review-notice"><TranslatedText text="You have already reviewed this product." /></div>
          )}

          {showForm && (
            <form className="mn-review-form" onSubmit={handleSubmit}>
              <h3 className="mn-review-form-title"><TranslatedText text="Write Your Review" /></h3>
              <div className="mn-review-form-field">
                ...
                {formData.rating === 0 && <span className="mn-review-form-hint"><TranslatedText text="Select a rating" /></span>}
              </div>
              <div className="mn-review-form-field">
