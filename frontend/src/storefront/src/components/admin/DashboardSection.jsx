...
export default function DashboardSection() {
  ...
  const periodLabel = (p) => p === 'today' ? "Today" : p === 'week' ? "This Week" : p === 'month' ? "This Month" : "All Time";
  const rangeLabel = period === 'today' ? "Today" : period === 'week' ? "This week" : period === 'month' ? "This month" : "Total";
