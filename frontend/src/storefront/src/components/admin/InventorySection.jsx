          ...
          <div className="card">
            <div className="card-header">
              <h3 className="card-title">
                {activeTab === 'out' ? `Out of Stock (${displayed.length})` : activeTab === 'low' ? `Low Stock (${displayed.length})` : activeTab === 'in' ? `In Stock (${displayed.length})` : `All Products (${displayed.length})`}
              </h3>
            </div>
            <div className="card-content">
              {displayed.length === 0 ? (
