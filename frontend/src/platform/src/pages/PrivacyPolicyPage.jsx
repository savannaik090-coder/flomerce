      ...
      <div className="container">
        ...
        <div className="legal-content">
          ...
          <section className="legal-summary" style={{ background: '#f1f5f9', borderRadius: 8, padding: '1rem 1.25rem', margin: '0 0 1.5rem' }}>
            ...
            <ul>
              <li>We collect your name, email, and account info to provide the platform.</li>
              <li>Payments are processed by Razorpay; we never store full card numbers.</li>
              <li>We do not sell your personal information to third parties.</li>
              <li>You can request access, correction, or deletion of your data at any time.</li>
              <li>Data is encrypted in transit and protected with industry-standard security.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              To exercise these rights, please contact us at <a href={`mailto:${SUPPORT_EMAIL}`}>{SUPPORT_EMAIL}</a> or <a href="tel:+919901954610">{PHONE}</a>. We will respond to all valid requests within 30 days.
            </p>
          </section>
