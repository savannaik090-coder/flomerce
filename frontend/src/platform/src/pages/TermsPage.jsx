      ...
      <div className="container">
        ...
        <div className="legal-content">
          ...
          <section className="legal-summary" style={{ background: '#f1f5f9', borderRadius: 8, padding: '1rem 1.25rem', margin: '0 0 1.5rem' }}>
            ...
            <ul>
              <li>By using Flomerce you agree to these terms; you must be 18 or older.</li>
              <li>Subscription fees are billed in advance through Razorpay; prices are in INR.</li>
              <li>Flomerce is a SaaS platform — we do not handle payments made on your customers' websites; each merchant uses their own Razorpay account.</li>
              <li>You own your content; you may not sell illegal, prohibited, or restricted goods.</li>
              <li>Indian law governs this agreement; disputes go to courts in Karnataka, India.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Flomerce offers various subscription plans with different features and pricing, viewable on our website. By subscribing to a paid plan, you agree to pay the applicable fees as described at the time of purchase. All payments are processed securely through Razorpay, a PCI DSS-compliant payment gateway. Subscription fees are billed in advance on a recurring basis depending on your chosen billing cycle. All prices are displayed in Indian Rupees (INR). Razorpay supports payments via credit cards, debit cards, UPI, net banking, and digital wallets. Standard payment gateway transaction fees as charged by Razorpay (currently 2% per transaction for most payment methods) may apply and are borne by Flomerce for platform subscription payments. These rates are determined by Razorpay and may change; refer to the Razorpay pricing page for current rates.{' '}
              <a href="https://razorpay.com/pricing" target="_blank" rel="noopener noreferrer">Razorpay's pricing page</a>.
            </p>
          </section>

          <section>
            <h2>5. Payment Processing & Gateway Integration</h2>
            <p>Flomerce operates as a standard merchant and is not a payment aggregator, facilitator, or intermediary. The platform handles two distinct types of payments:</p>
            <ul>
              ...
              <li><strong>Website Customer Payments:</strong> Payments made by end customers on websites created through Flomerce are processed entirely through the website owner's own, independently registered Razorpay merchant account. Website owners are required to obtain their own Razorpay account, complete their own KYC verification, and enter their own API credentials in their website dashboard settings.</li>
            </ul>
            <p>Flomerce does not collect, hold, pool, settle, or route any payments on behalf of website owners or their customers. All transaction funds flow directly from the customer to the website owner's Razorpay account. Flomerce has no access to or control over these funds at any point.</p>
        ...
        <footer className="legal-footer">
          ...
          <p style={{ color: '#94a3b8', fontSize: '0.75rem', marginTop: '0.5rem' }}>Karwar, Karnataka, India — 581400 | {PHONE} | {SUPPORT_EMAIL}</p>
        </footer>
      </div>
    </div>
  );
