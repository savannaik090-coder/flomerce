...
export default function LandingPage() {
  ...
  const features = [
    {
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
      ),
  ...
  return (
    <>
      <div className="landing-page">
        <div className="landing-dark-bg"></div>
        <div className="landing-inner">
          ...
          <section className="hero">
            <div className="hero-content reveal">
              ...
              <h1>Build Your<br /><span className="hero-gradient-text">Online Store</span><br />No Code Needed</h1>
              ...
              <div className="hero-buttons">
                ...
                <a href="#features" className="btn btn-hero-outline" onClick={(e) => { e.preventDefault(); document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' }); }}>Learn More</a>
              </div>
            </div>
            <div className="hero-glow"></div>
          </section>

          <section className="landing-section stats-section reveal">
                ...
                <div className="teaser-video-container">
                  ...
                  {!videoPlaying && (
                    <button className="teaser-play-btn" onClick={handlePlayVideo} aria-label="Play video">
                      <svg width="56" height="56" viewBox="0 0 56 56" fill="none"><circle cx="28" cy="28" r="28" fill="rgba(255,255,255,0.1)" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5"/><path d="M22 17l16 11-16 11V17z" fill="#fff"/></svg>
                    </button>
                  )}
                </div>
              </div>
