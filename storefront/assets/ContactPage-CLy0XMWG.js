import{u as j,r as l,j as e}from"./index-CKpoL8sX.js";import{u as y}from"./useSEO-CZjR3KO3.js";function N(){const{siteConfig:t}=j();y({title:"Contact Us"}),t?.brandName;const s=t?.phone||"",c=t?.email||"",d=t?.address||"",a=t?.socialLinks||{},[o,p]=l.useState({name:"",email:"",phone:"",subject:"",message:""}),[f,n]=l.useState(null),[m,x]=l.useState(!1);function r(i){p({...o,[i.target.name]:i.target.value})}const h=typeof window<"u"&&window.location.hostname.endsWith("fluxe.in")?"":"https://fluxe.in";async function u(i){i.preventDefault(),x(!0),n(null);try{const g=await fetch(`${h}/api/email/contact`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:o.name,email:o.email,phone:o.phone,message:`${o.subject?`Subject: ${o.subject}

`:""}${o.message}`,siteEmail:t?.email,brandName:t?.brandName})}),b=await g.json();g.ok&&b.success?(n("success"),p({name:"",email:"",phone:"",subject:"",message:""})):n("error")}catch{n("error")}finally{x(!1)}}return e.jsxs("div",{className:"contact-page",children:[e.jsx("style",{children:`
        .contact-hero {
