...
export default function JewellerySpotlightPlusTiles() {
  return (
    <section className="relative w-full bg-gradient-to-b from-slate-50 to-white py-16 sm:py-20 overflow-hidden font-sans">
      <div className="absolute inset-0 pointer-events-none opacity-60">
        <div className="absolute top-[10%] left-[10%] w-[35%] h-[40%] rounded-full bg-amber-100/40 blur-[120px]" />
        <div className="absolute top-[40%] right-[10%] w-[35%] h-[40%] rounded-full bg-rose-100/30 blur-[120px]" />
      </div>

      {/* Header */}
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8 text-center mb-12">
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 mb-4 max-w-3xl mx-auto leading-[1.05]">
          Whatever you sell, <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-rose-600 to-violet-600">we have a starter ready</span>
        </h2>
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8">
        <div className="relative rounded-[32px] bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-6 p-6 sm:p-10 lg:p-12">
            ...
            <div className="lg:col-span-4 order-2 lg:order-1 space-y-4">
              ...
              <h3 className="text-3xl md:text-4xl font-extrabold text-slate-900 leading-[1.1]">
                Built for <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-700 to-rose-600">jewellers</span>.
              </h3>
              ...
              <div className="flex items-center gap-1.5 text-sm text-slate-600 pt-1">
                ...
                <span className="font-medium">Trusted by 1,400+ jewellers</span>
              </div>
      ...
      {/* Divider */}
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8 mt-16 mb-8">
        <div className="flex items-end justify-between gap-6">
          <div>
            <div className="text-[11px] font-bold tracking-[0.25em] text-slate-500 uppercase mb-2">Other categories we love</div>
            <h3 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">Pick the one that's yours.</h3>
          </div>
          <div className="hidden md:block text-sm text-slate-500 max-w-xs text-right">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {TILES.map((ind) => (
            <article
              key={ind.id}
              className="relative flex flex-col bg-white rounded-[24px] shadow-sm ring-1 ring-slate-200/60 overflow-hidden group hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
            >
